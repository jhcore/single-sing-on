package es.capgemini.gav.kanbanWaffleSample.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see es.capgemini.gav.kanbanWaffleSample.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see es.capgemini.gav.kanbanWaffleSample.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
