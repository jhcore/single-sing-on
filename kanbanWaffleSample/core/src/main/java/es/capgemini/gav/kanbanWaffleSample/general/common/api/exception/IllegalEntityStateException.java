package es.capgemini.gav.kanbanWaffleSample.general.common.api.exception;

import es.capgemini.gav.kanbanWaffleSample.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link es.capgemini.gav.kanbanWaffleSample.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the kanbanWaffleSampleEntity entity.
