...
import es.capgemini.gav.kanbanWaffleSample.general.common.impl.security.ApplicationAuthenticationProvider;
import es.capgemini.gav.kanbanWaffleSample.general.common.impl.security.CsrfRequestMatcher;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  // Creamos una variable de la clase que configura el SSO
  private WinauthSSOImpl sso = new WinauthSSOImpl();
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    // Añadimos los filtros y el entry point
    http
        // Waffle filters
        .addFilterAfter(this.sso.getWaffleNegotiateSecurityFilter(), BasicAuthenticationFilter.class)
