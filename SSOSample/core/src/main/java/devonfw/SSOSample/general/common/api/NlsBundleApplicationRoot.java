package devonfw.SSOSample.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see devonfw.SSOSample.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see devonfw.SSOSample.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
