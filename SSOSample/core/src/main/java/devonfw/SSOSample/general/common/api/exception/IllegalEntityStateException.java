package devonfw.SSOSample.general.common.api.exception;

import devonfw.SSOSample.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link devonfw.SSOSample.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the SSOSampleEntity entity.
