package devonfw.SSOSample.general.common.impl.security;
 ...
 */
// @Named
public class PrincipalAccessControlProviderImpl {
  // implements PrincipalAccessControlProvider<UserProfile> {
  //
  // /**
  // * The constructor.
  // */
