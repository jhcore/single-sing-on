...
import devonfw.SSOSample.general.common.impl.security.CsrfRequestMatcher;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  // .antMatchers("/", "/home").permitAll().anyRequest().authenticated().and().formLogin().loginPage("/login")
  // .permitAll().and().logout().permitAll().and().addFilterBefore(
  // spnegoAuthenticationProcessingFilter(authenticationManagerBean()), BasicAuthenticationFilter.class);
  //
  // // this.authenticationManagerBuilder.authenticationProvider(kerberosServiceAuthenticationProvider());
  //
  // }
  ...
  // new FilterBasedLdapUserSearch(this.ldapSearchBase, this.ldapSearchFilter, kerberosLdapContextSource());
